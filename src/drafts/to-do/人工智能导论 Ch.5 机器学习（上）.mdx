...
## 机器学习的核心：归纳偏置(Inductive Bias，或称为归纳性偏好)
  ...
  + ![Inductive-Bias](./人工智能导论%20Ch.5%20机器学习（上）/InductiveBias.png)
## 机器学习的基本过程
  + 从原始数据中提取特征
  + 学习映射函数$f$
...
### 一元线性回归
+ 回归模型：$y=ax+b$
+ ![linear regression](./人工智能导论%20Ch.5%20机器学习（上）/linear_regression_example.png)
...
+ ![sigmoid](./人工智能导论%20Ch.5%20机器学习（上）/Logistic-curve.svg)
+ Sigmoid函数的特点：
...
+ 例子：(虽然下面这图是个梗图，但也可以看作一种决策树)![chart](./人工智能导论%20Ch.5%20机器学习（上）/wd40.jpg)
...
+ 图示：![Ada](./人工智能导论%20Ch.5%20机器学习（上）/Ada.png)
### 算法描述
1. 数据样本权重初始化   
...
+ 下图为二类分类问题的最佳分类平面示例：![svm](./人工智能导论%20Ch.5%20机器学习（上）/svm.png)
...
![svm-risk](./人工智能导论%20Ch.5%20机器学习（上）/svm-risk.png)
## 线性可分支持向量机
...
![lsvm](./人工智能导论%20Ch.5%20机器学习（上）/linear-svm.png)
