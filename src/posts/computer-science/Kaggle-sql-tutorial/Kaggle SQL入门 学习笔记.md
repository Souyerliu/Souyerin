...
tags:
  - SQL
  - BigQuery
cover: ./Kaggle SQL入门 学习笔记/cover.jpg
---

> 2026.02.26更新：由于6月1日之后谷歌BigQuery的旧版sql指令将会失效，故本系列笔记可能不再适用，仅作留档。  
> 新版GoogleSQl指路：[GoogleSQL](https://docs.cloud.google.com/bigquery/docs/introduction-sql?hl=zh-cn)  
> Kaggle教程链接：<https://www.kaggle.com/learn/intro-to-sql>  
...
![dataset-table](./Kaggle%20SQL入门%20学习笔记/table.png)
...
这样可以显著加快`.to_dataframe()`的速度。3. 接着，我们利用`query`获取特定的数据：
...
- 原始表格：
  ![origin](./Kaggle%20SQL入门%20学习笔记/origin.png)
...
- ![join](./Kaggle%20SQL入门%20学习笔记/join.png)
