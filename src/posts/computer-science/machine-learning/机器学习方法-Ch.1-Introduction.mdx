...
+ 是一条横坐标$FP$，纵坐标$TP$的曲线，表示不同参数/分类准则下，$TP$和$FP$的关系。
    + 参考图如下（图源[维基百科](https://zh.wikipedia.org/wiki/ROC%E6%9B%B2%E7%BA%BF)）：<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/13/Roc_curve.svg/500px-Roc_curve.svg.png" alt="ROC" width="500" />
