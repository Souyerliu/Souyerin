...
+ 能否对稀疏共现矩阵进行数据压缩/降维？可以！使用奇异值分解即可。【参见[CS 127笔记](https://souyerin.netlify.app/posts/computer-science/cs127/cs127-chapter-4/#奇异值分解singular-value-decompositionsvd)】
## Word2Vec
