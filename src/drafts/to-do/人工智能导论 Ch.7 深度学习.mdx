...
+ MCP模型结构图如下：
![mcp](./人工智能导论%20Ch.7%20深度学习/mcp.png)
...
|名称|函数|图像|导数|值域|
|:---:|:---:|:---:|:--------:|:---:|
|**sigmoid**|$f(x)=\frac{1}{1+e^{-x}}$|![sigmoid](./人工智能导论%20Ch.7%20深度学习/sigmoid.png)|$f'(x)=f(x)(1-f(x))$|$(0,1)$|
|**tanh**|$f(x)=\frac{1-e^{-2x}}{1+e^{-2x}}$|![tanh](./人工智能导论%20Ch.7%20深度学习/tanh.png)|$f'(x)=1-f^2(x)$|$(-1,1)$|
|**ReLU(rectified linear unit,修正线性单元)**|$f(x)=\begin{cases} 0 & for\hspace{0.3em}x\leq 0 \\x & for\hspace{0.3em}x>0 & & \end{cases}$|![ReLU](./人工智能导论%20Ch.7%20深度学习/ReLU.png)|$f'(x)=\begin{cases} 0 & for\hspace{0.3em}x\leq 0 \\1 & for\hspace{0.3em}x>0 & & \end{cases}$|$[0,\infty)$|
...
+ 单层感知机可作为一种两类线性分类模型，结构如下图所示：![perceptron](./人工智能导论%20Ch.7%20深度学习/perceptron.png)
  其中$b$为偏置项(bias)。    
...
![logic](./人工智能导论%20Ch.7%20深度学习/logic.png)
## 感知机模型：多层感知机
...
具体结构图如下：
![mlp](./人工智能导论%20Ch.7%20深度学习/mlp.png)
## 参数优化与学习
...
具体结构图如下：
![bp](./人工智能导论%20Ch.7%20深度学习/bp.png)  
...
![bp-example](./人工智能导论%20Ch.7%20深度学习/bp_example.png)
...
![CNN](./人工智能导论%20Ch.7%20深度学习/CNN.png)
### 常见的池化操作
...
## 循环神经网络模型
循环神经网络结构及其展开形式示意图如下：
![RNN](./人工智能导论%20Ch.7%20深度学习/RNN.png)
...
![BPTT](./人工智能导论%20Ch.7%20深度学习/BPTT.png)
...
+ 模型示意图如下：
![LSTM](./人工智能导论%20Ch.7%20深度学习/LSTM.png)   
...
![RLG](./人工智能导论%20Ch.7%20深度学习/RNN_LSTM_GRU.png)
...
+ 模型示意图如下：
![GAN](./人工智能导论%20Ch.7%20深度学习/GAN.png)
...
+ 具体算法实现如下!!实在懒得敲字了QAQ!!：
![GAN-algorithm](./人工智能导论%20Ch.7%20深度学习/GAN-Algorithm.png)
...
## 图像分类和目标定位
话不多说，直接上图（具体细节同样省略）：
![location](./人工智能导论%20Ch.7%20深度学习/location.jpg)
