---
title: 统计学习方法 Ch.1 Introduction
...
+ 示例图如下：![fitting](./统计学习方法-Ch.1-Introduction/fitting.png)
...
+ **Bias-Variance Trade-off**（偏差-方差权衡）
    ...
    + 二者与模型自由度（复杂度）的关系如图（对应不同数据分布）：![trade-off](./统计学习方法-Ch.1-Introduction/trade-off.png)
