...
+ 三种语句比较图如下：
![joins](./Kaggle%20SQL进阶%20学习笔记/joins.png)
...
+ 我们直接通过例子进行叙述：
+ 已知现有两名运动员的训练数据如下：
![training](./Kaggle%20SQL进阶%20学习笔记/training.png)
...
![nested](./Kaggle%20SQL进阶%20学习笔记/nested.png)
...
## Repeated Data
+ 有时在表格的一格内有多个数据，如下图：
![repeated](./Kaggle%20SQL进阶%20学习笔记/repeated.png)
...
![unnest](./Kaggle%20SQL进阶%20学习笔记/unnest.png)
这相当于将所有聚合的数据进行平铺。
## nested and repeated data
+ 如果上面两种数据同时存在在一列数据中，如下图所示：
![nested and repeated](./Kaggle%20SQL进阶%20学习笔记/nested_and_repeated.png)
...
3. 避免使用 N:N JOINs
   ...
   ![1-1join](./Kaggle%20SQL进阶%20学习笔记/1-1join.png)
   + 这被称为“ **1:1 JOIN** ”。如果一个表格的一行数据可与另一个表格的多行数据匹配，如下图：
   ![n-1join](./Kaggle%20SQL进阶%20学习笔记/n-1join.png)
   + 那么就被称为“ **N:1 JOIN** ”。同理，如果一个表格的多行数据与另一个表格的多行数据相互匹配，如下图：
   ![n-njoin](./Kaggle%20SQL进阶%20学习笔记/n-njoin.png)
   + 就被称为“ **N:N JOIN** ”。
